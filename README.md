...
- Leah - "I quite enjoy learning NodeJS in class so I decided to focus on specilising in building the back-end through the project. My strength through the project is my good understanding of NodeJS, I feel much more confident working with backend using NodeJS compared to Ruby on Rails, I am comfortable setting up our Schema, database, controllers & routes. With more practice in the projects,I also improved on using console to diagnose bugs. I also find it fun to work in pairs for some unknown features such as RSS feed, it was fun to be able to discuss and research together as a pair to find a good fit solution for given problem. In addition, I also find my project management and planning skills helped our team to arrange our tasks in a organised manner, and ensure we finish our tasks in a timely manner each sprint. In the future, I would like to improve on how to diagonise  customise and handle errors better and also have more exposure in the front-end to build on my REACT skills."